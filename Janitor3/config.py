shops = [{'user': 'homeone', 'pwd': 'Homeone123'},
         {'user': 'kidstoys', 'pwd': 'Kidstoys123'},
         {'user': 'shoppingcenter', 'pwd': 'Familystore123'}]

sms_token = 'HzewQfbqinZr7h0BCHzldZ7kuSS62so9dVUqJtmp'
